# Useful pattern for optimizing queries against vector databases

# REAL WORLD TIPS:
# for efficiency - use a super small model to rewrite the prompt, then use a more powerful model to actually run the query
